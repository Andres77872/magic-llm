...
OPENAI_KEY = json.load(open('/home/andres/Documents/keys.json'))['amazon']

OPENAI_KEY["callback"] = _get_callback
# MODEL = 'amazon.titan-text-lite-v1'
MODEL = 'amazon.nova-pro-v1:0'
# MODEL = 'us.anthropic.claude-3-5-haiku-20241022-v1:0'
# MODEL = 'arn:aws:bedrock:us-east-1:296897261059:inference-profile/us.anthropic.claude-3-5-haiku-20241022-v1:0'
MODEL_FAIL = 'amazon.titan-text-lite-v3'
